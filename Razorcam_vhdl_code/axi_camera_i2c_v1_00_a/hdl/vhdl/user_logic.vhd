...
entity user_logic is
  ...
  (
    ...
    -- ADD USER GENERICS ABOVE THIS LINE ---------------
		SYSTEM_CLOCK					: positive	:= 100000000;			-- 100 MHz
    -- DO NOT EDIT BELOW THIS LINE ---------------------
  ...
  (
	...
	IP_SDA_I                       : in  std_logic;
		...
		IP_SDA_T                       : out std_logic;
		IP_SCL                         : out std_logic;
    -- DO NOT EDIT BELOW THIS LINE ---------------------
...
component I2C
  ...
  ------------------------------------------
  signal slv_reg0                       : std_logic_vector(0 to C_SLV_DWIDTH-1);	-- start read/write operation
  signal slv_reg1                       : std_logic_vector(0 to C_SLV_DWIDTH-1);	-- read data and i2c-status (read only register)
...
begin
	...
	port map(
		...
		RW_Sel		=> slv_reg0(0),
		Valid_In		=> slv_reg_write_sel(0),
		Reg_Addr		=> slv_reg0(8 to 15),
		Data_In		=> slv_reg0(16 to 31),
		Valid_Out	=> slv_reg1(2),
		Data_Out		=> slv_reg1(16 to 31),
		Busy			=> slv_reg1(0),
		Error			=> slv_reg1(1),
		SDA_I			=> IP_SDA_I,
		SDA_O			=> IP_SDA_O,
        ...
        case slv_reg_write_sel is
          when "10" =>
            ...
            if slv_reg0(0) = '0' then
              slv_reg1(8 to 15) <= slv_reg0(8 to 15);
            end if;
 --         when "01" =>
--            for byte_index in 0 to (C_SLV_DWIDTH/8)-1 loop
 --             if ( Bus2IP_BE(byte_index) = '1' ) then
